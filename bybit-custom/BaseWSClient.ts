...
import { DefaultLogger } from 'bybit-api/lib/util/logger'
import {
  MessageEventLike,
...
import { WsStore } from 'bybit-api/lib/util/websockets/WsStore'
import {
  WSConnectedResult,
  WS_LOGGER_CATEGORY,
  ...
  safeTerminateWs,
} from 'bybit-api/lib/util/websockets'
import { WsOperation } from 'bybit-api/lib/types/websockets/ws-api'
...
> extends EventEmitter {
  ...
  public async close(wsKey: TWSKey, force?: boolean) {
